...
$b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\PhysiqueBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\MoraleBundle\\Entity')));

$c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
$c->addDriver($b, 'PhysiqueBundle\\Entity');
$c->addDriver($b, 'MoraleBundle\\Entity');

$d = new \Doctrine\ORM\Configuration();
$d->setEntityNamespaces(array('PhysiqueBundle' => 'PhysiqueBundle\\Entity', 'MoraleBundle' => 'MoraleBundle\\Entity'));
