...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('v9CLwDApxq', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hUOHLAiRsE', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('baseurl', 'http://127.0.0.1:8000/service/');
        $instance->addGlobal('websitebase', 'http://127.0.0.1:8000/');
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ag79bZwjBs', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NuIyM4ZaOG', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i8r7XWp3j4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2b57e9ce049e9918cf34e47a12132ac9a890bc7a')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\vendor\\vich\\uploader-bundle/Resources/views'), '!VichUploader');
        $instance->addPath(($this->targetDirs[3].'\\src\\PhysiqueBundle/Resources/views'), 'Physique');
        $instance->addPath(($this->targetDirs[3].'\\src\\PhysiqueBundle/Resources/views'), '!Physique');
        $instance->addPath(($this->targetDirs[3].'\\src\\HomeBundle/Resources/views'), 'Home');
        $instance->addPath(($this->targetDirs[3].'\\src\\HomeBundle/Resources/views'), '!Home');
        $instance->addPath(($this->targetDirs[3].'\\src\\MoraleBundle/Resources/views'), 'Morale');
        $instance->addPath(($this->targetDirs[3].'\\src\\MoraleBundle/Resources/views'), '!Morale');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2b57e9ce049e9918cf34e47a12132ac9a890bc7a');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PhysiqueBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PhysiqueBundle'),
                ...
                'MoraleBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\MoraleBundle'),
                    'namespace' => 'MoraleBundle',
                ),
            ...
            case 'vich_uploader.mappings': $value = array(
                'global_image' => array(
                    'uri_prefix' => '/Images',
                    'upload_destination' => ($this->targetDirs[3].'/web/Images'),
                    'namer' => array(
                        'service' => NULL,
                        'options' => NULL,
                    ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PhysiqueBundle' => 'PhysiqueBundle\\PhysiqueBundle',
                'HomeBundle' => 'HomeBundle\\HomeBundle',
                'MoraleBundle' => 'MoraleBundle\\MoraleBundle',
            ...
            'secret' => '2b57e9ce049e9918cf34e47a12132ac9a890bc7a',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '2b57e9ce049e9918cf34e47a12132ac9a890bc7a',
