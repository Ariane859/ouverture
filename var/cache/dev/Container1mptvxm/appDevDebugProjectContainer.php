...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\HomeBundle/Resources/views'), '!Home');
        $instance->addPath(($this->targetDirs[3].'\\src\\PieceBundle/Resources/views'), 'Piece');
        $instance->addPath(($this->targetDirs[3].'\\src\\PieceBundle/Resources/views'), '!Piece');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'PieceBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\PieceBundle'),
                    'namespace' => 'PieceBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PieceBundle' => 'PieceBundle\\PieceBundle',
