...
namespace Proxies\__CG__\MoraleBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Morale extends \MoraleBundle\Entity\Morale implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'id', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'sigle', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'raisonSociale', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'dateCreation', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'email', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'telephone', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'pays', '' . "\0" . 'MoraleBundle\\Entity\\Morale' . "\0" . 'ville'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Morale $proxy) {
